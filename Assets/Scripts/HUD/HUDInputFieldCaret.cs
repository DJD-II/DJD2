...
namespace CurvedHUD
{
    ...
    /// </summary>
    public class HUDInputFieldCaret : MonoBehaviour, ISelectHandler, IDeselectHandler
    {
        //references
        InputField myField;
        ...
        void CreateCaret()
        {
            ...
            go.AddComponent<HUDVertexEffect>();
        ...
        void UpdateCaret()
        {
            ...
            { // user is not selecting text, just update the caret position.
